...
@implementation ZZTimeLineCellOperationMenu
{
...
-(void)setup{
    ...
    self.backgroundColor = [UIColor colorWithRed:67/255.0 green:74/255.0 blue:76/255.0 alpha:1];
